...
const GenderSelection = () => {
  ...
  const renderGenderOption = (id, label, value, bgColor, icon) => (
    <div className="relative flex h-[50px] w-[50px] items-center justify-center">
      ...
      />
      <div
        className={`absolute h-full w-full rounded-full ${bgColor} p-2 shadow-sm shadow-[#00000050] ring-${
          bgColor.split("-")[1]
        }-400 duration-300 peer-checked:scale-110 peer-checked:ring-2`}
      />
      <div className="absolute -z-10 h-full w-full scale-0 rounded-full bg-opacity-20 duration-500 peer-checked:scale-[500%]" />
